 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const lt=globalThis,Re=lt.trustedTypes,yt=Re?Re.createPolicy("lit-html",{createHTML:o=>o}):void 0,Ft="$lit$",V=`lit$${Math.random().toFixed(9).slice(2)}$`,Bt="?"+V,mi=`<${Bt}>`,ee=document,ge=()=>ee.createComment(""),be=o=>o===null||typeof o!="object"&&typeof o!="function",ct=Array.isArray,yi=o=>ct(o)||typeof o?.[Symbol.iterator]=="function",Fe=`[ 	
\f\r]`,fe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,kt=/-->/g,_t=/>/g,G=RegExp(`>|${Fe}(?:([^\\s"'>=/]+)(${Fe}*=${Fe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),wt=/'/g,Tt=/"/g,jt=/^(?:script|style|textarea|title)$/i,ki=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),w=ki(1),M=Symbol.for("lit-noChange"),N=Symbol.for("lit-nothing"),$t=new WeakMap,Y=ee.createTreeWalker(ee,129);function It(o,e){if(!ct(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return yt!==void 0?yt.createHTML(e):e}const _i=(o,e)=>{const t=o.length-1,i=[];let s,n=e===2?"<svg>":e===3?"<math>":"",c=fe;for(let r=0;r<t;r++){const l=o[r];let a,d,h=-1,O=0;for(;O<l.length&&(c.lastIndex=O,d=c.exec(l),d!==null);)O=c.lastIndex,c===fe?d[1]==="!--"?c=kt:d[1]!==void 0?c=_t:d[2]!==void 0?(jt.test(d[2])&&(s=RegExp("</"+d[2],"g")),c=G):d[3]!==void 0&&(c=G):c===G?d[0]===">"?(c=s??fe,h=-1):d[1]===void 0?h=-2:(h=c.lastIndex-d[2].length,a=d[1],c=d[3]===void 0?G:d[3]==='"'?Tt:wt):c===Tt||c===wt?c=G:c===kt||c===_t?c=fe:(c=G,s=void 0);const R=c===G&&o[r+1].startsWith("/>")?" ":"";n+=c===fe?l+mi:h>=0?(i.push(a),l.slice(0,h)+Ft+l.slice(h)+V+R):l+V+(h===-2?r:R)}return[It(o,n+(o[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class me{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let n=0,c=0;const r=e.length-1,l=this.parts,[a,d]=_i(e,t);if(this.el=me.createElement(a,i),Y.currentNode=this.el.content,t===2||t===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(s=Y.nextNode())!==null&&l.length<r;){if(s.nodeType===1){if(s.hasAttributes())for(const h of s.getAttributeNames())if(h.endsWith(Ft)){const O=d[c++],R=s.getAttribute(h).split(V),E=/([.?@])?(.*)/.exec(O);l.push({type:1,index:n,name:E[2],strings:R,ctor:E[1]==="."?Ti:E[1]==="?"?$i:E[1]==="@"?vi:De}),s.removeAttribute(h)}else h.startsWith(V)&&(l.push({type:6,index:n}),s.removeAttribute(h));if(jt.test(s.tagName)){const h=s.textContent.split(V),O=h.length-1;if(O>0){s.textContent=Re?Re.emptyScript:"";for(let R=0;R<O;R++)s.append(h[R],ge()),Y.nextNode(),l.push({type:2,index:++n});s.append(h[O],ge())}}}else if(s.nodeType===8)if(s.data===Bt)l.push({type:2,index:n});else{let h=-1;for(;(h=s.data.indexOf(V,h+1))!==-1;)l.push({type:7,index:n}),h+=V.length-1}n++}}static createElement(e,t){const i=ee.createElement("template");return i.innerHTML=e,i}}function ae(o,e,t=o,i){if(e===M)return e;let s=i!==void 0?t._$Co?.[i]:t._$Cl;const n=be(e)?void 0:e._$litDirective$;return s?.constructor!==n&&(s?._$AO?.(!1),n===void 0?s=void 0:(s=new n(o),s._$AT(o,t,i)),i!==void 0?(t._$Co??=[])[i]=s:t._$Cl=s),s!==void 0&&(e=ae(o,s._$AS(o,e.values),s,i)),e}class wi{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??ee).importNode(t,!0);Y.currentNode=s;let n=Y.nextNode(),c=0,r=0,l=i[0];for(;l!==void 0;){if(c===l.index){let a;l.type===2?a=new ye(n,n.nextSibling,this,e):l.type===1?a=new l.ctor(n,l.name,l.strings,this,e):l.type===6&&(a=new Ni(n,this,e)),this._$AV.push(a),l=i[++r]}c!==l?.index&&(n=Y.nextNode(),c++)}return Y.currentNode=ee,s}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class ye{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=N,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ae(this,e,t),be(e)?e===N||e==null||e===""?(this._$AH!==N&&this._$AR(),this._$AH=N):e!==this._$AH&&e!==M&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):yi(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==N&&be(this._$AH)?this._$AA.nextSibling.data=e:this.T(ee.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=me.createElement(It(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{const n=new wi(s,this),c=n.u(this.options);n.p(t),this.T(c),this._$AH=n}}_$AC(e){let t=$t.get(e.strings);return t===void 0&&$t.set(e.strings,t=new me(e)),t}k(e){ct(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const n of e)s===t.length?t.push(i=new ye(this.O(ge()),this.O(ge()),this,this.options)):i=t[s],i._$AI(n),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){const i=e.nextSibling;e.remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class De{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,n){this.type=1,this._$AH=N,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=N}_$AI(e,t=this,i,s){const n=this.strings;let c=!1;if(n===void 0)e=ae(this,e,t,0),c=!be(e)||e!==this._$AH&&e!==M,c&&(this._$AH=e);else{const r=e;let l,a;for(e=n[0],l=0;l<n.length-1;l++)a=ae(this,r[i+l],t,l),a===M&&(a=this._$AH[l]),c||=!be(a)||a!==this._$AH[l],a===N?e=N:e!==N&&(e+=(a??"")+n[l+1]),this._$AH[l]=a}c&&!s&&this.j(e)}j(e){e===N?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Ti extends De{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===N?void 0:e}}class $i extends De{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==N)}}class vi extends De{constructor(e,t,i,s,n){super(e,t,i,s,n),this.type=5}_$AI(e,t=this){if((e=ae(this,e,t,0)??N)===M)return;const i=this._$AH,s=e===N&&i!==N||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==N&&(i===N||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class Ni{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){ae(this,e)}}const Ri=lt.litHtmlPolyfillSupport;Ri?.(me,ye),(lt.litHtmlVersions??=[]).push("3.2.1");const Ei=(o,e,t)=>{const i=t?.renderBefore??e;let s=i._$litPart$;if(s===void 0){const n=t?.renderBefore??null;i._$litPart$=s=new ye(e.insertBefore(ge(),n),n,void 0,t??{})}return s._$AI(o),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let L=class extends ne{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ei(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}};L._$litElement$=!0,L.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:L});const xi=globalThis.litElementPolyfillSupport;xi?.({LitElement:L});(globalThis.litElementVersions??=[]).push("4.1.1");/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ai=o=>typeof o!="string"&&"strTag"in o,Ct=(o,e,t)=>{let i=o[0];for(let s=1;s<o.length;s++)i+=e[t?t[s-1]:s-1],i+=o[s];return i};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wt=o=>Ai(o)?Ct(o.strings,o.values):o;let j=Wt,vt=!1;function Oi(o){if(vt)throw new Error("lit-localize can only be configured once");j=o,vt=!0}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Nt=new WeakMap,Rt=new Map;function ji(o,e,t){if(o){const i=t?.id??Ii(e),s=o[i];if(s){if(typeof s=="string")return s;if("strTag"in s)return Ct(s.strings,e.values,s.values);{let n=Nt.get(s);return n===void 0&&(n=s.values,Nt.set(s,n)),{...s,values:n.map(c=>e.values[c])}}}}return Wt(e)}function Ii(o){const e=typeof o=="string"?o:o.strings;let t=Rt.get(e);return t===void 0&&(t=Bi(e,typeof o!="string"&&!("strTag"in o)),Rt.set(e,t)),t}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Be(o){window.dispatchEvent(new CustomEvent(it,{detail:o}))}let Ee="",je,Mt,xe,nt,qt,J=new Vt;J.resolve();let we=0;const Ci=o=>(Oi((e,t)=>ji(qt,e,t)),Ee=Mt=o.sourceLocale,xe=new Set(o.targetLocales),xe.add(o.sourceLocale),nt=o.loadLocale,{getLocale:Wi,setLocale:Vi}),Wi=()=>Ee,Vi=o=>{if(o===(je??Ee))return J.promise;if(!xe||!nt)throw new Error("Internal error");if(!xe.has(o))throw new Error("Invalid locale code");we++;const e=we;return je=o,J.settled&&(J=new Vt),Be({status:"loading",loadingLocale:o}),(o===Mt?Promise.resolve({templates:void 0}):nt(o)).then(i=>{we===e&&(Ee=o,je=void 0,qt=i.templates,Be({status:"ready",readyLocale:o}),J.resolve())},i=>{we===e&&(Be({status:"error",errorLocale:o,errorMessage:i.toString()}),J.reject(i))}),J.promise};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Zt=Symbol.for(""),gs=o=>{if(o?.r===Zt)return o?._$litStatic$},bs=o=>({_$litStatic$:o,r:Zt}),Pt=new Map,ms=o=>(e,...t)=>{const i=t.length;let s,n;const c=[],r=[];let l,a=0,d=!1;for(;a<i;){for(l=e[a];a<i&&(n=t[a],(s=gs(n))!==void 0);)l+=s+e[++a],d=!0;a!==i&&r.push(n),c.push(l),a++}if(a===i&&c.push(e[i]),d){const h=c.join("$$lit$$");(e=Pt.get(h))===void 0&&(c.raw=c,Pt.set(h,e=c)),t=r}return o(e,...t)},ys=ms(w);var pt=function(o,e,t,i){var s=arguments.length,n=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,i);else for(var r=o.length-1;r>=0;r--)(c=o[r])&&(n=(s<3?c(n):s>3?c(e,t,n):c(e,t))||n);return s>3&&n&&Object.defineProperty(e,t,n),n};let Oe=class extends L{constructor(){super(...arguments),this.value=""}static{this.styles=q`
  ...
  `}onChange(e){this.inputValue=e.target.value}get inputValue(){return this.value}set inputValue(e){this.dispatchEvent(new CustomEvent("update",{detail:{value:e}}))}render(){return w`
    ...
    `}};ft([y({type:Object})],Ue.prototype,"options",void 0);ft([y({type:Number,attribute:!1})],Ue.prototype,"value",void 0);Ue=ft([z("feedback-fusion-field-number"),dt()],Ue);var ke=function(o,e,t,i){var s=arguments.length,n=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,i);else for(var r=o.length-1;r>=0;r--)(c=o[r])&&(n=(s<3?c(n):s>3?c(e,t,n):c(e,t))||n);return s>3&&n&&Object.defineProperty(e,t,n),n};let le=class extends L{constructor(){super(),this.value=0,this.starColor=[]}static{this.styles=q`
  ...
  `}onChange(e){this.inputValue=e.target.value,this.starColor=this.starColor.map((t,i)=>+e.target.value>i?"rgb(var(--feedback-fusion-primary))":"rgb(var(--feedback-fusion-inactive))")}get inputValue(){return this.value}set inputValue(e){this.dispatchEvent(new CustomEvent("update",{detail:{value:e}}))}connectedCallback(){this.starColor=new Array(this.options.max).fill("rgb(var(--feedback-fusion-inactive))"),super.connectedCallback()}render(){return w`
      ...
      `)}
    `}};ke([y({type:String})],le.prototype,"fieldId",void 0);ke([y({type:Object})],le.prototype,"options",void 0);ke([y({type:Number,attribute:!1})],le.prototype,"value",void 0);ke([y({attribute:!1})],le.prototype,"starColor",void 0);le=ke([z("feedback-fusion-field-rating")],le);var ut=function(o,e,t,i){var s=arguments.length,n=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,i);else for(var r=o.length-1;r>=0;r--)(c=o[r])&&(n=(s<3?c(n):s>3?c(e,t,n):c(e,t))||n);return s>3&&n&&Object.defineProperty(e,t,n),n};let Pe=class extends L{constructor(){super(...arguments),this.value=!1}static{this.styles=q`
    label input {
      height: 0;
      width: 0;
      display: none;
  ...
  `}onChange(e){this.inputValue=e.target.checked}get inputValue(){return this.value}set inputValue(e){this.dispatchEvent(new CustomEvent("update",{detail:{value:e}}))}render(){return w`
      ...
      `}
    `}};ut([y({type:Object})],Pe.prototype,"options",void 0);ut([y({type:Boolean,attribute:!1})],Pe.prototype,"value",void 0);Pe=ut([z("feedback-fusion-field-checkbox")],Pe);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Jt=o=>(...e)=>({_$litDirective$:o,values:e});let Yt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 ...
 */const Qt="important",ks=" !"+Qt,tt=Jt(class extends Yt{constructor(o){if(super(o),o.type!==Gt.ATTRIBUTE||o.name!=="style"||o.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(o){return Object.keys(o).reduce((e,t)=>{const i=o[t];return i==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(o,[e]){const{style:t}=o.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?t.removeProperty(i):t[i]=null);for(const i in e){const s=e[i];if(s!=null){this.ft.add(i);const n=typeof s=="string"&&s.endsWith(ks);i.includes("-")||n?t.setProperty(i,n?s.slice(0,-11):s,n?Qt:""):t[i]=s}}return M}});var H=function(o,e,t,i){var s=arguments.length,n=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,i);else for(var r=o.length-1;r>=0;r--)(c=o[r])&&(n=(s<3?c(n):s>3?c(e,t,n):c(e,t))||n);return s>3&&n&&Object.defineProperty(e,t,n),n};let C=class extends L{constructor(){super(...arguments),this.left=0,this.right=0,this.dragLeft=!1,this.dragRight=!1}static{this.styles=q`
  ...
  `}onUpdate(e){this.fieldValue=e.detail.value}set fieldValue(e){this.dispatchEvent(new CustomEvent("update",{detail:{value:e}}))}get fieldValue(){return this.value}fieldTypeString(){return Object.keys(re).find(e=>re[e]===this.fieldType).toLowerCase()}render(){return ys`
    ...
    `}};de([y({type:String})],te.prototype,"fieldId",void 0);de([y({type:String})],te.prototype,"fieldTitle",void 0);de([y({type:String})],te.prototype,"fieldType",void 0);de([y({type:Object})],te.prototype,"options",void 0);de([y({attribute:!1})],te.prototype,"value",void 0);te=de([z("feedback-fusion-field"),dt()],te);const _s="en",ws=["de"],{getLocale:Fs,setLocale:Ts}=Ci({sourceLocale:_s,targetLocales:ws,loadLocale:o=>oi(Object.assign({"./generated/locales/de.js":()=>ai(()=>import("./de.BlLPDByF.js"),__vite__mapDeps([0,1,2]))}),`./generated/locales/${o}.js`,4)});var A=function(o,e,t,i){var s=arguments.length,n=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,i);else for(var r=o.length-1;r>=0;r--)(c=o[r])&&(n=(s<3?c(n):s>3?c(e,t,n):c(e,t))||n);return s>3&&n&&Object.defineProperty(e,t,n),n};let x=class extends L{constructor(){super(),this.autoClose=!1,this.closeAfter=1e3,this.locale="en",this.currentFieldPage=1,this.data={},this.error=!1,this.fields=[],this.finished=!1,this.open=!0,this.totalFieldPages=1,Se(this)}static{this.styles=q`
    :host {
  ...
  `}async connectedCallback(){super.connectedCallback(),Ts(this.locale),this.clientProvider=new rs(new hs({baseUrl:this.baseUrl})),await this._fetchPrompt().catch(console.error),await this._fetchFields().catch(console.error)}async _fetchPrompt(){await this.clientProvider.getPrompt({id:this.promptId}).then(e=>this.prompt=e.response)}async _fetchFields(){await this.clientProvider.getActiveFields({prompt:this.promptId,pageSize:10,pageToken:this.currentFieldPage}).then(e=>{this.totalFieldPages=Math.ceil(e.response.total/10),this.fields=e.response.fields})}async _submitResponse(){const e={};Object.keys(this.data).forEach(t=>e[t]={data:this.data[t]}),await this.clientProvider.createResponses({data:e,prompt:this.prompt.id}).then(()=>{this.data={},this.finished=!0,this.autoClose&&setTimeout(()=>this.open=!1,this.closeAfter||5e3)}).catch(()=>this.error=!0)}onUpdate(e){return t=>{let i={};i[e]=t.detail.value,this.data={...this.data,...i}}}render(){return w`
      ...
      `:""}
    `}};A([y({type:Boolean})],x.prototype,"autoClose",void 0);A([y({type:String})],x.prototype,"baseUrl",void 0);A([y({type:Number})],x.prototype,"closeAfter",void 0);A([y({type:String})],x.prototype,"locale",void 0);A([y({type:String})],x.prototype,"promptId",void 0);A([y({attribute:!1})],x.prototype,"clientProvider",void 0);A([y({attribute:!1})],x.prototype,"currentFieldPage",void 0);A([y({attribute:!1})],x.prototype,"data",void 0);A([y({attribute:!1})],x.prototype,"error",void 0);A([y({attribute:!1})],x.prototype,"fields",void 0);A([y({attribute:!1})],x.prototype,"finished",void 0);A([y({attribute:!1})],x.prototype,"open",void 0);A([y({attribute:!1})],x.prototype,"prompt",void 0);A([y({attribute:!1})],x.prototype,"totalFieldPages",void 0);x=A([z("feedback-fusion-prompt"),dt()],x);export{w as x};
