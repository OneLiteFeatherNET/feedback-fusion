...
export default [
  http.options("https://mock.mock/feedback-fusion-v1.PublicFeedbackFusionV1/*", () => {
  ...
  http.post(
    "https://mock.mock/feedback_fusion_v1.PublicFeedbackFusionV1/GetPrompt",
    () => {
  ...
  http.post(
    "https://mock.mock/feedback_fusion_v1.PublicFeedbackFusionV1/GetActiveFields",
    () => {
      return createGrpcResponse(
        {
          "pageToken": 1,
